/////////////////////////
module data_extract8_v1(in, rc, regime, mant);
function [31:0] log2;
...
module reg_op (exp_o, r_o);
parameter Bs=5;
input [Bs:0] exp_o;
output [Bs-1:0] r_o;

wire [Bs:0] exp_oN_tmp;
conv_2c #(.N(Bs)) uut_conv_2c1 (~exp_o[Bs:0],exp_oN_tmp);
wire [Bs:0] exp_oN = exp_o[Bs] ? exp_oN_tmp[Bs:0] : exp_o[Bs:0];
assign r_o = (~exp_o[Bs]) ? exp_oN[Bs-1:0] + 1 : exp_oN[Bs-1:0];
endmodule
